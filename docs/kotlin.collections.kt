...
public final class ArrayDeque<E> : kotlin.collections.AbstractMutableList<E> {
    ...
    public constructor(initialCapacity: kotlin.Int)

    public constructor(elements: kotlin.collections.Collection<E>)
...
public open class ArrayList<E> : kotlin.collections.AbstractMutableList<E>, kotlin.collections.MutableList<E>, kotlin.collections.RandomAccess {
    ...
    constructor(initialCapacity: kotlin.Int)

    constructor(elements: kotlin.collections.Collection<E>)
...
public open class HashMap<K, V> : kotlin.collections.AbstractMutableMap<K, V>, kotlin.collections.MutableMap<K, V> {
    ...
    public constructor(initialCapacity: kotlin.Int, loadFactor: kotlin.Float)

    public constructor(original: kotlin.collections.Map<out K, V>)
...
public final data class IndexedValue<out T> {
    public constructor(index: kotlin.Int, value: T)
